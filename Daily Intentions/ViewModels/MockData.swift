...
struct MockData {
    static let intentions: [MockIntention] = [
        ...
        MockIntention(
            ...
            themeId: PresetThemes.forest.id,
            aiGenerated: true,
        ...
        MockIntention(
            ...
            themeId: PresetThemes.sunset.id
        ),
        MockIntention(
            ...
            themeId: PresetThemes.midnight.id,
            aiGenerated: true
        ),
        MockIntention(
            ...
            themeId: PresetThemes.minimal.id
        ),
        MockIntention(
    ...
    static func getTheme(byId id: UUID) -> PresetTheme? {
        PresetThemes.all.first { $0.id == id }
    }
}
