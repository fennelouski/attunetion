...
class IntentionRepository {
    ...
    func getIntention(for date: Date, scope: IntentionScope) -> Intention? {
        ...
        let predicate: Predicate<Intention>
        ...
        case .week:
            ...
            predicate = #Predicate<Intention> { intention in
                intention.scope == .week &&
                intention.date >= weekStart &&
                intention.date < weekEnd
            }
        ...
        case .month:
            ...
            predicate = #Predicate<Intention> { intention in
                intention.scope == .month &&
                intention.date >= monthStart &&
                intention.date < monthEnd
            }
        }
